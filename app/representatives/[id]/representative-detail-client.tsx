...
export function RepresentativeDetailClient() {
            ...
            <div className="flex-1 space-y-2 sm:space-y-3 text-center sm:text-left w-full">
              ...
              >
                ...
                <ShareButtons
                  ...
                  description={`Learn about ${member.fullName}, ${member.party} ${member.chamber === 'House' ? 'Representative' : 'Senator'} from ${member.state}${member.district ? ` District ${member.district}` : ''}`}
                  hashtags={["Hakivo", "Congress", member.party?.substring(0, 3).toUpperCase() || "POL"]}
                  size="sm"
                />
              </div>
            </div>
