...
import { Play, Pause, Download, ArrowLeft, Calendar, Clock, FileText, Scale, User, Newspaper } from "lucide-react"
...
export function PodcastEpisodeClient({ episode }: PodcastEpisodeClientProps) {
  const { play, pause, currentTrack, isPlaying } = useAudioPlayer()
  const isThisEpisodePlaying = currentTrack?.id === episode.id && isPlaying
