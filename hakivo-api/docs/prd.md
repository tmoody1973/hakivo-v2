...
| cerebras-client | service (private) | Fast LLM inference for RAG and bill analysis | Calls Cerebras llama3.1-70b for chat completions with streaming support, bill AI analysis (what it does, who it affects, key provisions, potential benefits/concerns), dashboard summaries, enforces 100 req/min limit, provides ~1-2s response time |
