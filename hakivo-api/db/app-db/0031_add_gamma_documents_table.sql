-- Migration: Add gamma_documents table for Gamma professional document generation
-- Stores references to Gamma-generated presentations, documents, and webpages
-- Linked to artifacts as source content, with export files stored in Vultr

CREATE TABLE IF NOT EXISTS gamma_documents (
  id TEXT PRIMARY KEY,
  user_id TEXT NOT NULL,
  artifact_id TEXT,  -- Optional source artifact
