...
import { Ai, Annotation, App, KvCache, Logger, MRNObject, Payments, Queue, ServiceStub, SmartBucket, SmartMemory, SmartSql, SqlDatabase, Tracer,  } from '@liquidmetal-ai/raindrop-framework';
...
export interface Env {
  ...
  CONGRESSIONAL_MEMORY: SmartMemory;
