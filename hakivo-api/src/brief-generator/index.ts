...
...`;
    ...
    console.log(`✓ Generated script with Claude Sonnet 4.5: ${script.length} characters, headline: "${headline}"`);
...
End with an empowering note about staying informed.`;
    ...
    console.log(`✓ Generated written article with Claude Sonnet 4.5: ${wordCount} words`);
