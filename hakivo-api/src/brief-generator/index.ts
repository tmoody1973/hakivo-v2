 ...
 * - Stage 5: Script generation (Gemini 3 Pro - rich, atmospheric writing)
 * - Stage 6: Article generation (Gemini 3 Pro - emotional depth & coherence)
...
...`;
    ...
    // Use Gemini 3 Pro - Rich, atmospheric writing with emotional depth
    ...
    console.log(`✓ Generated script with Gemini 3 Pro: ${script.length} characters, headline: "${headline}"`);
...
End with an empowering note about staying informed.`;
    ...
    console.log(`✓ Generated written article with Gemini 3 Pro: ${wordCount} words`);
