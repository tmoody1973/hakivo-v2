 ...
 * - Stage 5: Script generation (Gemini 2.5 Flash)
 * - Stage 6: Article generation (Gemini 2.5 Flash)
...
...`;
    ...
    // Use Gemini 2.5 Flash - NO web search, only provided data
    ...
    console.log(`✓ Generated script with Gemini 2.5 Flash: ${script.length} characters, headline: "${headline}"`);
...
End with an empowering note about staying informed.`;
    ...
    console.log(`✓ Generated written article with Gemini 2.5 Flash: ${wordCount} words`);
